              ...
              <CardContent>
                ...
                <Box sx={{ mt: 4 }}>
                 ...
                 <Typography variant="h6" color="text.secondary" gutterBottom sx={{ fontSize: '16px' }} >
                    <strong>Images not working? Try these sample images.</strong> (Due to  <strong>Render's</strong> RAM limitations, we are using NumPy,OpenCV instead of RemBG, which may not work properly as expected.)
                  </Typography>
